...
return {
  ...
  config = function()
    ...
    Color.new("sand1", "#161615") -- fg, main text
    Color.new("sand2", "#1c1c1a")
    Color.new("sand3", "#232320")
    Color.new("sand4", "#282826")
    Color.new("sand5", "#2e2e2b")
    Color.new("sand6", "#353431") -- fg_subtle, a little bit lighter
    Color.new("sand7", "#3e3e3a")
    Color.new("sand8", "#51504b")
    Color.new("sand9", "#717069")
    Color.new("sand10", "#7f7e77") -- fg_faded, lightest, for comments
    Color.new("sand11", "#a1a09a")
    Color.new("sand12", "#ededec")

    -- Amber for base UI background
    Color.new("amber1", "#fefdfb")
    Color.new("amber2", "#fff9ed") -- bg
    Color.new("amber3", "#fff4d5") -- bg1 for CursorLine and CursorColumn
    Color.new("amber4", "#ffecbc")
    Color.new("amber5", "#ffe3a2")
    Color.new("amber6", "#ffd386") -- bg2 for line numbers
    Color.new("amber7", "#f3ba63") -- bg3 for current line number
    ...
    Color.new("fg", "#161615")
    Color.new("fg1", "#353431")
    Color.new("fg2", "#7f7e77")

    Color.new("bg", "#fff9ed")
    Color.new("bg1", "#fff4d5")
    Color.new("bg2", "#ffecbc")
    Color.new("bg3", "#f3ba63")
    Color.new("line", "#ad5700")
    Color.new("cline", "#4e2009")
    ...
    Group.new("ColorColumn", c.none, c.bg1, no)
    ...
    Group.new("VertSplit", c.fg, c.none, b)
    Group.new("Folded", c.fg1, c.none, no)
    Group.new("FoldColumn", c.fg2, c.none, no)
    Group.new("IncSearch", c.none, c.green_bg, no)
    Group.new("LineNr", c.line, c.none, no)
    Group.new("CursorLineNr", c.cline, c.none, b)
    Group.new("MatchParen", c.none, c.bg1, no)
    Group.new("Italic", c.none, c.none, i)
    Group.new("ModeMsg", c.none, c.none, no)
    Group.new("MoreMsg", c.fg1, c.none, no)
    Group.new("NonText", c.none, c.none, no)

    Group.new("PMenu", c.fg1, c.bg1, no)
    Group.new("PMenuSel", c.none, c.bg1, r)
    Group.new("PMenuSbar", c.fg2, c.fg2, no)
    Group.new("PMenuThumb", c.fg1, c.fg1, no)

    Group.new("Question", c.none, c.none, no)
    Group.new("Search", c.none, c.bg2, no)
    Group.new("SpecialKey", c.none, c.none, no)
    Group.new("Whitespace", c.none, c.none, no)
    Group.new("StatusLine", c.none, c.fg1, r)
    Group.new("StatusLineNC", c.none, c.fg2, no)

    -- Tablines aren't really configd
    Group.new("TabLine", c.none, c.none, no)
    Group.new("TabLineFill", c.none, c.none, no)
    Group.new("TabLineSel", c.fg1, c.none, no)
    ...
    -- what the fuck is this Group.new('TooLong', c.none,  c.none,   no)
    Group.new("WildMenu", c.fg1, c.bg1, no)
    ...
    Group.new("Comment", c.fg2, c.none, no)

    -- constant values like strings numbers chars etc
    Group.new("Constant", c.fg1, c.none, no)
    ...
    Group.new("Statement", c.fg2, c.none, b)

    -- variable names and function names
    Group.new("Identifier", c.none, c.none, u)
    Group.new("Function", c.none, c.none, b)

    -- preprocessoer directives
    Group.new("PreProc", c.fg2, c.none, no)

    -- int long char etc.
    Group.new("Type", c.fg1, c.none, no)

    -- special symbols and debug statements, idk
    Group.new("Special", c.fg1, c.none, no)
    Group.new("Debug", c.fg1, c.none, no)

    -- individual groupings of stuff
    ...
    -----------------------------
    -- I don't know shit about treesitter
    ...
    Group.new("LspDiagnosticsFloatingError", c.none, c.red_bg, ul)
    Group.new("LspDiagnosticsFloatingWarning", c.none, c.yellow_bg, ul)
    Group.new("LspDiagnosticsFloatingInformation", c.none, c.yellow_bg, ul)
    Group.new("LspDiagnosticsFloatingHint", c.none, c.yellow_bg, ul)

    Group.new("LspDiagnosticsSignError", c.red, c.none, no)
    Group.new("LspDiagnosticsSignWarning", c.yellow, c.none, no)
    Group.new("LspDiagnosticsSignInformation", c.fg2, c.none, no)
    Group.new("LspDiagnosticsSignHint", c.yellow, c.none, no)

    -- virtual text stuff, i dont use this
    ...
    ----------------------------
    -- VERY WEIRD MANUAL FLOATING WINDOW SETTING
    Group.new("FloatBorder", c.fg, c.none, b)
    Group.new("NormalFloat", c.fg, c.bg, no)
    Group.new("TelescopeSelection", c.none, c.none, r)    -- selected item
    Group.new("TelescopeSelectionCaret", c.none, c.none, b) -- selection caret
    Group.new("TelescopeMultiSelection")                  -- multisections
    Group.new("TelescopeNormal", c.fg, c.bg, no)          -- floating windows created by  telescope

    -- border highlight groups
    Group.new("TelescopeBorder", c.fg, c.none, no)
    Group.new("TelescopePromptBorder", g.TelescopeBorder, g.TelescopeBorder, g.TelescopeBorder)
    Group.new("TelescopeResultsBorder", g.TelescopeBorder, g.TelescopeBorder, g.TelescopeBorder)
    Group.new("TelescopePreviewBorder", g.TelescopeBorder, g.TelescopeBorder, g.TelescopeBorder)

    -- characters that you match
    Group.new("TelescopeMatching", c.none, c.none, b)
